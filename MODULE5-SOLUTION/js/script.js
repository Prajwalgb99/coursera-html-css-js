...
// ************* STEP 0 *************
// Random category short_name function
...
// ************* STEP 2 *************
// Build home page HTML once categories are loaded
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // Insert randomCategoryShortName into {{randomCategoryShortName}}
      var homeHtmlToInsertIntoMainPage =
        insertProperty(homeHtml, "randomCategoryShortName", "'" + randomCategoryShortName + "'");

      // Insert HTML into main page
...
// Load the menu items view for a category
